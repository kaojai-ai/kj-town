...
export function createMaterialPalette(): MaterialPalette {
    return {
        ...
        screenBlue: new THREE.MeshStandardMaterial({ color: 0x6cc9ff, emissive: 0x2b7fbf, emissiveIntensity: 0.6 }),
        screenAmber: new THREE.MeshStandardMaterial({ color: 0xffc45a, emissive: 0xd28a20, emissiveIntensity: 0.6 }),
        partnerMetal: new THREE.MeshStandardMaterial({ color: 0xd9dde7, metalness: 0.8, roughness: 0.2 }),
